...
\htmladdtonavigation
   {\begin{rawhtml}
 <A HREF="https://heasarc.gsfc.nasa.gov/docs/software/fitsio/fitsio.html">FITSIO Home</A>
    \end{rawhtml}}
...
\begin{verbatim}
        https://heasarc.gsfc.nasa.gov/cgi-bin/ftoolshelp
\end{verbatim}
...
Office at {\tt https://fits.gsfc.nasa.gov/}.  In particular, the
...
Joye. See https://heasarc.gsfc.nasa.gov/docs/journal/axaf7.html for
...
Users should refer to the FITS Support Office at {\tt https://fits.gsfc.nasa.gov/}
...
https://fits.gsfc.nasa.gov/registry/hierarch\_keyword.html
and in Section 4.4 of the ESO Data Interface Control Document that
is linked to from
https://archive.eso.org/cms/tools-documentation/eso-data-interface-control.html.
...
https://fits.gsfc.nasa.gov under the WCS link.
...
\begin{verbatim}
      https://heasarc.gsfc.nasa.gov/FTP/software/fitsio/c/root/rootd.tar.gz
\end{verbatim}
...
"((a.le.x).and.(x.le.b))".  Despite the apperance of the notation with
an equals sign, the value of x is not changed (and x is evaluated only
once).  To avoid confusing some parsers, it is best to enclose the
expression within a parenthesis, such as, "(x=a:b)".
...
\end{verbatim}
    ...
    https://fits.gsfc.nasa.gov/registry/region.html
